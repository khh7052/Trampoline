...
IL_0052:
	{
		...
		bool L_12;
		L_12 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)273), NULL);
		if (L_12)
		{
			goto IL_0067;
		}
	...
	{
		bool L_13;
		L_13 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)119), NULL);
		if (!L_13)
		{
			goto IL_006f;
		}
...
IL_006f:
	{
		...
		bool L_14;
		L_14 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)274), NULL);
		if (L_14)
		{
			goto IL_0084;
		}
	...
	{
		bool L_15;
		L_15 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)115), NULL);
		if (!L_15)
		{
			goto IL_008b;
		}
...
IL_0048:
	...
	}
	{
		...
		String_t* L_16;
		L_16 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(L_15, _stringLiteral11BBC07DB720D8AC1FA700D648938720AD568A4C, NULL);
...
IL_0097:
	{
		...
		String_t* L_25;
		L_25 = String_Concat_mF8B69BE42B5C5ABCAD3C176FBBE3010E0815D65D(L_23, _stringLiteralA7A626DEA2521BA48EA03C7C5828601203370D81, L_24, _stringLiteral2043A81282FBC38D068F48CE6B02508288E7F859, NULL);
...
IL_0042:
	{
		...
		L_10 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(L_7, ((float)il2cpp_codegen_multiply(((float)L_8), L_9)), NULL);
...
IL_0050:
	{
		...
		String_t* L_19;
		L_19 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(L_18, _stringLiteral8649F4FD2D10AA91241D05393F34CFB465556BF8, NULL);
		NullCheck(L_16);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AllIn1Shader_SetMaterial_mFB4610A2350B9E76A2FD3EC0EF25AA87591C2A2E (AllIn1Shader_t14B58455C6D71CBE6DD81780F56A0EBEAFB51F7D* __this, int32_t ___action0, bool ___getShaderTypeFromPrefs1, String_t* ___shaderName2, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		int32_t L_5;
		L_5 = PlayerPrefs_GetInt_m35C13A87BBC7907554CE5405EB5D00CF85E7457B(_stringLiteral83A7D7134699CC119AD32B86F73B3360AC11C2F9, NULL);
		V_1 = L_5;
	...
	}
	{
		...
		L_9 = Resources_Load_mDCC8EBD3196F1CE1B86E74416AD90CF86320C401(_stringLiteralC8DE5A01354A14D63623212DAD24AF32886D3324, L_8, NULL);
...
IL_0044:
	...
	}
	{
		...
		L_13 = Resources_Load_mDCC8EBD3196F1CE1B86E74416AD90CF86320C401(_stringLiteral91091474F29416A7473D8C4907A4C9072DF22614, L_12, NULL);
...
IL_0064:
	...
	}
	{
		...
		L_17 = Resources_Load_mDCC8EBD3196F1CE1B86E74416AD90CF86320C401(_stringLiteral1E70DB3EED474F0B3BC0F85291266523C145CAC4, L_16, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AllIn1Shader_CleanMaterial_m33B4E8D8F99E06BE24C5D10FAAEB9061FDCD0F75 (AllIn1Shader_t14B58455C6D71CBE6DD81780F56A0EBEAFB51F7D* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		L_4 = Shader_Find_mFF2A8FC042B9CFAA9800679CA674D52859BF3A72(_stringLiteral975A5F46FC6E6D8BC7943A3A38CEA489C122E4F1, NULL);
...
IL_002e:
	...
	}
	{
		...
		L_10 = Shader_Find_mFF2A8FC042B9CFAA9800679CA674D52859BF3A72(_stringLiteral975A5F46FC6E6D8BC7943A3A38CEA489C122E4F1, NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AllIn1Shader_SaveMaterialWithOtherName_m5568A821C67EFF400BB280AE5BD33107EE1FCBD8 (AllIn1Shader_t14B58455C6D71CBE6DD81780F56A0EBEAFB51F7D* __this, String_t* ___path0, int32_t ___i1, const RuntimeMethod* method) 
{
	...
	String_t* V_1 = NULL;
	{
		...
		String_t* L_4;
		L_4 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(L_3, _stringLiteralA0F4CF9D3B8B4AD6A49A888401B14AE51DD52E16, NULL);
		V_1 = L_4;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AllIn1Shader_CheckIfValidTarget_m2A4FB22EE8427CCBF9515BC9207274958F048CE6 (AllIn1Shader_t14B58455C6D71CBE6DD81780F56A0EBEAFB51F7D* __this, const RuntimeMethod* method) 
{
	...
	Graphic_tCBFCA4585A19E2B75465AECFEAC43F4016BF7931* V_0 = NULL;
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_2;
		L_2 = Object_op_Equality_mD3DB0D72CE0250C84033DC2A90AEF9D59896E536(L_0, (Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C*)NULL, NULL);
		if (!L_2)
		{
			goto IL_0024;
		}
...
IL_004d:
	{
		...
		float L_92;
		L_92 = Vector3_Dot_m4688A1A524306675DBDB1E6D483F35E85E3CE6D8_inline(L_20, L_91, NULL);
		...
		L_129 = Vector2_op_Multiply_m4EEB2FF3F4830390A53CE9B6076FB31801D65EED_inline(L_127, L_128, NULL);
		V_22 = L_129;
...
IL_02f9:
	...
	}
	{
		...
		L_179 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_169, L_178, NULL);
		V_29 = L_179;
		// pixelsToAverage++;
		float L_180 = V_28;
...
IL_0358:
	{
		...
		L_190 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_181, L_189, NULL);
		V_29 = L_190;
		// pixelsToAverage++;
		float L_191 = V_28;
	...
	}
	{
		...
		L_206 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_196, L_205, NULL);
		V_29 = L_206;
		// pixelsToAverage++;
		float L_207 = V_28;
...
IL_03b4:
	...
	}
	{
		...
		L_219 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_210, L_218, NULL);
		V_29 = L_219;
		// pixelsToAverage++;
		float L_220 = V_28;
...
IL_03e2:
	...
	}
	{
		...
		L_234 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_225, L_233, NULL);
		V_29 = L_234;
		// pixelsToAverage++;
		float L_235 = V_28;
...
IL_0415:
	...
	}
	{
		...
		L_252 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_242, L_251, NULL);
		V_29 = L_252;
		// pixelsToAverage++;
		float L_253 = V_28;
...
IL_0454:
	{
		...
		L_263 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_254, L_262, NULL);
		V_29 = L_263;
		// pixelsToAverage++;
		float L_264 = V_28;
	...
	}
	{
		...
		L_279 = Color_op_Addition_m39AF1619A5E6C1F698EEF20FA5FE6F3288902AAB_inline(L_269, L_278, NULL);
		V_29 = L_279;
		// pixelsToAverage++;
		float L_280 = V_28;
...
IL_04b0:
	{
		...
		L_288 = Color_op_Division_m1C9D39C3D4B9AC3343E08D0ED4DD64E33D40A5FF_inline(L_286, L_287, NULL);
		NullCheck(L_281);
...
IL_0048:
	...
	}
	{
		...
		float L_18;
		L_18 = Random_Range_mF26F26EB446B76823B4815C91FA0907B484DF02B((0.0f), (1000.0f), NULL);
		NullCheck(L_16);
...
IL_0087:
	{
		...
		String_t* L_21;
		L_21 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteralAF4C1963FC25CEBA356B471D3766D6A06B902D8A, L_20, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
...
IL_00a2:
	{
		...
		L_23 = Object_get_name_mAC2F6B897CF1303BA4249B4CB55271AFACBB6392(L_22, NULL);
		String_t* L_24;
		L_24 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteralEC1448C3684BCF31933FFFC9FE903C9316AF00E3, L_23, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
...
IL_000e:
	...
	}
	{
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_3;
		L_3 = Object_op_Inequality_m4D656395C27694A7F33F5AA8DE80A7AAF9E20BA7(__this, (Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C*)NULL, NULL);
		if (!L_3)
		{
			goto IL_002d;
		}
...
IL_0009:
	...
	{
		bool L_27;
		L_27 = Application_get_isPlaying_m0B3B501E1093739F8887A0DAC5F61D9CB49CC337(NULL);
		if (!L_27)
		{
			goto IL_0113;
		}
